 ...
 const Courses = 
  ...
  return (
    ...
    <h1 className='text-center font-semibold font-montserat bg-gradient-to-r text-white from-indigo-800 to-cyan-600 py-[2px]'>Home Page</h1>
     ...
     {/* container */}
     <div className=' flex flex-col justify-center bg-white  items-center pt-4 md:flex-row md:justify-evenly md:px-9 md:py-4
      ...
      {/* image */}
       ...
       {/* text */}
        <div className='max-w-[300px] px-3 py-4 h-fit text-indigo-800 font-josefins sm:max-w-[600px]'>
      <h3>
          <Typewriter 
          options={{
            autoStart:true,
